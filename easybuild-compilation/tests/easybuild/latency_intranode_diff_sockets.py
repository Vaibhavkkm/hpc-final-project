...
@rfm.simple_test
class OSULatencyIntraNodeDiffSocketsEasyBuildTest(rfm.RunOnlyRegressionTest):
    descr = 'OSU Latency Test with EasyBuild (Intra-Node, Different Sockets)'
    valid_systems = ['*']
    ...
    tags = {'latency', 'easybuild', 'intranode', 'diff_sockets'}
